...
public class HomePageConstants {
    ...
    public static final String LIBRARY_LINK_TEXT = "Library";
    public static final String REPORTS_LINK_TEXT = "Reports";
    public static final String TEAM_TEXT = "Team";
    public static final String HIGHLIGHTS_LINK_TEXT = "Highlights";
    public static final String RECRUITING_TEXT = "Recruiting";
    public static final String FEED_TEXT = "Feed";
    public static final String FEATURED_TEXT = "Featured";
